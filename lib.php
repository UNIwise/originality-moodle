...
class plagiarism_plugin_originality extends plagiarism_plugin {
    ...
    */
    ...
    public function print_disclosure($cmid) {
        ...
        $formatoptions = originality stdClass;
        $formatoptions->noclean = true;
        echo format_text($plagiarismsettings['originality_student_disclosure'], FORMAT_MOODLE, $formatoptions);
        echo $OUTPUT->box_end();
    }
...
function originality_event_mod_created($eventdata) {
    $result = true;
        //a originality module has been created - this is a generic event that is called for all module types
